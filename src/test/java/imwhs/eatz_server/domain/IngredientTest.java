...
//    void isChildOfTest() {
//        // when, then
//        Assertions.assertTrue(parent1.hasChildAs(child1));
//    }
//
//    @Test
...
//        // when, then
//        Assertions.assertTrue(child1.hasParentAs(parent1));
//    }
//
//    @Test
...
//        // when, then
//        Assertions.assertTrue(parent1.hasChildAs(grandchild));
//    }
//
//    @Test
...
//        // when, then
//        Assertions.assertTrue(grandchild.hasParentAs(parent1));
//    }
//
//    @Test
...
//        // when, then
//        Assertions.assertFalse(child2.hasChildAs(parent1));
//    }
//
//    @Test
...
//        // when, then
//        Assertions.assertFalse(parent1.hasParentAs(child2));
//    }
//
//    @Test
...
//        // when, then
//        Assertions.assertFalse(parent1.hasChildAs(parent1));
//    }
//
//    @Test
...
//        // when, then
//        Assertions.assertFalse(parent1.hasParentAs(parent1));
//    }
//
//    @Test
...
//
//        // then
//        Assertions.assertFalse(parent1.hasChildAs(ingredient));
//    }
//
//    @Test
...
//
//        // then
//        Assertions.assertFalse(parent1.hasParentAs(ingredient));
//    }
//
//    @Test
...
//
//        // when, then
//        Assertions.assertTrue(flour.hasChildAs(sugar)); // sugar가 flour의 하위 재료인지 확인
...
//    void setParentTest() {
//        // when
//        sugar.setParent(flour);
//
//        // when, then
//        assertTrue(sugar.hasParentAs(flour)); // flour가 sugar의 카테고리인지 확인
...
//    void setParentFailTest() {
//        // when
//        IllegalArgumentException exception = assertThrows(IllegalArgumentException.class, () -> sugar.setParent(sugar));
//
//        // then
...
//
//        // when
//        IllegalArgumentException exception = assertThrows(IllegalArgumentException.class, () -> flour.setParent(salt));
//
//        // then
...
//        Assertions.assertEquals(exception.getMessage(), "하위 계층에 추가할 재료가 이미 " + sugar.getParent().getName() + " 카테고리에 속해 있습니다.");
...
//    void changeCategoryTest_setParent() {
//        // given
//        sugar.setParent(flour);
//        sugar.setParent(baking);
//
//        // when, then
