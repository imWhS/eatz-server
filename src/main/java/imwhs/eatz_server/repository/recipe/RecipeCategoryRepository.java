...
import imwhs.eatz_server.dto.recipe.RecipeCategoryDto;
...
public interface RecipeCategoryRepository extends JpaRepository<RecipeCategory, Long> {
    ...
    @Query("select new imwhs.eatz_server.dto.recipe.RecipeCategoryDto(rc.recipe.id, rc.category.id, rc.category.name) " +
