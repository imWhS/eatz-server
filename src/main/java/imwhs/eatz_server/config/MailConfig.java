...
public class MailConfig {
    ...
    private Properties javaMailProperties() {
        ...
        javaMailProperties.put("mail.smtp.starttls.enable", properties.getSmtp().getStarttls().isEnable());
        javaMailProperties.put("mail.smtp.connectiontimeout", properties.getSmtp().getConnectiontimeout());
        javaMailProperties.put("mail.smtp.timeout", properties.getSmtp().getTimeout());
        javaMailProperties.put("mail.smtp.writetimeout", properties.getSmtp().getWritetimeout());
