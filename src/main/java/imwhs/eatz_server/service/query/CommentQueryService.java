...
/**
 * 댓글(Comment) 관련 정보를 조회하는 CommentQueryService 클래스입니다.
...
public class CommentQueryService {
     ...
     * @param id 레시피 식별자
     */
    public PagedApiResponse<CommentItemDto> findCommentsByRecipe(Long id, Integer currentPage, Integer pagingSize) {
        int page = currentPage == null ? DEFAULT_CURRENT_PAGE : currentPage;
        int size = pagingSize == null ? DEFAULT_PAGING_SIZE : pagingSize;

        List<CommentItemDto> data = commentQueryRepository.findCommentsByRecipe(id, page, size);
