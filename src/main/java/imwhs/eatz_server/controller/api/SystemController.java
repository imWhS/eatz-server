...
public class SystemController {
    ...
    public ClientLaunchNoticeResponse getLatestClientLaunchNotice() {
        return new ClientLaunchNoticeResponse(
                ...
                "환영합니다!",
                """
                        안녕하세요! 바로 요리할 수 있는 모든 레시피, EATZ입니다!
                        
                        EATZ는 가지고 있는 재료와 도구만으로 지금 당장 요리할 수 있는 레시피를 찾아주는 소셜 레시피 플랫폼이에요. 또한, 단순히 레시피를 찾는 것 뿐만 아니라, 플래너와 체크리스트를 통해 요리 일정 별 준비해야 할 재료와 도구까지 체계적으로 관리할 수 있어요.
                        
                        EATZ의 주요 기능을 알려드릴게요.
                        
                        #### 보관함 기반 맞춤형 레시피 탐색
                        
                        - 더 이상 레시피에 재료와 도구를 맞출 필요 없어요. 가지고 계신 재료와 도구를 보관함에 추가해보세요. EATZ가 보관함에 추가되어 있는 재료와 도구를 바탕으로 지금 당장 요리할 수 있는 레시피를 빠르고 정확하게 찾아드려요.
                        ...
                        - 플래너의 원하는 날짜 혹은, 기간 내에 요리할 레시피를 바탕으로, 사전에 준비해야 할 재료와 도구를 체크리스트를 만들어드려요. 체크리스트를 통해서 레시피 별 요리 가능 여부 뿐 아니라 모든 레시피를 요리하기 위해 준비해야 할 재료와 도구가 무엇인지까지 한눈에 파악하실 수 있어요.
                        
                        #### 레시피 공유 및 소셜 커뮤니케이션
                        
                        - 나만의 레시피를 직접 등록하고, 사람들과 공유해보세요.\s
                        - 다른 사람들의 레시피를 탐색하며 새로운 영감을 얻고, 댓글과 평가를 남기며 소통할 수도 있어요.
