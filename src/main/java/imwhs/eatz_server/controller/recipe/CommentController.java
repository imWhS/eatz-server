...
public class CommentController {
    ...
    public ResponseEntity<ApiResponse<Paged<CommentResponseDto>>> findComments(
            @PathVariable Long id,
            @PageableDefault(page = 0, size = 10) Pageable pageable) {
        Page<CommentResponseDto> comments = commentService.findCommentsByRecipe(id, pageable);
